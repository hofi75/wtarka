...
uses
  ...
  uTALDBComboBox, SzarmazasiIgazolasPrint;
...
var
  szip: TSzarmazasiIgazolasPrint;
begin
  szip := TSzarmazasiIgazolasPrint.Create(self); 
  szip.Print( sdsKeresENAR.Value, sdsKeresSOR.Value, sdsKeresPER.Value);
  szip.Destroy;
  (*
