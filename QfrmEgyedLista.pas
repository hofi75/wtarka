...
begin
  ...
  if edtTenyeszetTipus.Text <> EmptyStr then begin
    feltetelek := feltetelek + 'Tenyészet típus= ' + edtTenyeszetTipus.Text + #10;
    PlusWhere := PlusWhere + ' AND TIPUS = ' + quotedstr(edtTenyeszetTipus.Text);
  end;
